...
public class HelpActivity extends AppCompatActivity {
    ...
    private void showUpdateInfo() {
        ...
        DiaryVo diaryVo15 = new DiaryVo();
        diaryVo15.setId(R.drawable.head_hibara);
        diaryVo15.setMyUuid("HibaraAi");
        diaryVo15.setModifiedDate(BaseUtils.dateToString(new Date()));
        diaryVo15.setLocationStr("我已经在尽力完善APP了");
        diaryVo15.setLabelStr("#1.5.0版本#");
        ...
        DiaryVo diaryVo18 = new DiaryVo();
        diaryVo18.setId(R.drawable.head_hibara);
        diaryVo18.setMyUuid("HibaraAi");
        diaryVo18.setModifiedDate(BaseUtils.dateToString(new Date()));
        diaryVo18.setLocationStr("我已经在尽力完善APP了");
        diaryVo18.setLabelStr("#1.5.2.1版本#");
        diaryVo18.setContent(Constant.STRING_UPDATE_18);
        diaryVos.add(diaryVo18);

        DiaryVo diaryVo19 = new DiaryVo();
        diaryVo19.setId(R.drawable.head_hibara);
        diaryVo19.setMyUuid("HibaraAi");
        diaryVo19.setModifiedDate(BaseUtils.dateToString(new Date()));
        diaryVo19.setLocationStr("我已经在尽力完善APP了");
        diaryVo19.setLabelStr("#1.5.3版本#");
        diaryVo19.setContent(Constant.STRING_UPDATE_19);
        diaryVos.add(diaryVo19);

        DiaryVo diaryVo20 = new DiaryVo();
        diaryVo20.setId(R.drawable.head_hibara);
        diaryVo20.setMyUuid("HibaraAi");
        diaryVo20.setModifiedDate(BaseUtils.dateToString(new Date()));
        diaryVo20.setLocationStr("我已经在尽力完善APP了");
        diaryVo20.setLabelStr("#1.5.4版本#");
        diaryVo20.setContent(Constant.STRING_UPDATE_20);
        diaryVos.add(diaryVo20);

        DiaryVo diaryVo21 = new DiaryVo();
        diaryVo21.setId(R.drawable.head_hibara);
        diaryVo21.setMyUuid("HibaraAi");
        diaryVo21.setModifiedDate(BaseUtils.dateToString(new Date()));
        diaryVo21.setLocationStr("我已经在尽力完善APP了");
        diaryVo21.setLabelStr("#1.6.0版本#");
