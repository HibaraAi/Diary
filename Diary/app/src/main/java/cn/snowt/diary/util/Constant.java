...
//            "A：别问，问就是BUG，目前来看这是偶发BUG，问题不大，不修。多点一下就可以回到顶部。\n" +
    ...
    public static final String STRING_UPDATE_0 = "2025年1月1日更新此版本（1.5.3）\n" +
            ...
            "3. 输入框弹出时，输入法一并弹出\n" +
            "4. 数据分析的优化\n" +
            "5. 更换图片浏览器，使其能打开超长图片，同时支持滑动切图和放大图片功能\n" +
            "6. 所有的耗时操作都适配进度条动画，解决软件很卡的问题。" +
            "7. 新增Blog模式，支持边插入图片、视频边写文字\n";
