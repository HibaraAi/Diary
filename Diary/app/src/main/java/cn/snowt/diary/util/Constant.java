...
public class Constant {
    ...
    public static final String STRING_HELP_1 = "一、功能介绍\n" +
            "本软件“消消乐”是一个本地日记记录程序，一条日记可以记录2000字符以下的文本和最多50张配图、最多8个视频。" +
            ...
            "最后，未写完的日记可以存储到草稿箱暂存，需要注意的是，只会为你暂存日记文本，且不会加密存储。";
    ...
    public static final String STRING_HELP_3 = "三、权限使用说明\n" +
            ...
            "因为这些不是作者有意申请的，可能是在引用别人的代码时，别人代码有申请这些权限。";
...
//            "A：别问，问就是BUG，目前来看这是偶发BUG，问题不大，不修。多点一下就可以回到顶部。\n" +
    ...
    public static final String STRING_UPDATE_2 = "2021年9月18日更新1.1版本。\n" +
            ...
            "3. 删除没有更多日记的重复提示\n" +
            "4. 新增置顶功能\n" +
            "5. 长按日记文本改为弹出菜单：删除、置顶、复制日记、进入详情页、编辑日记文本\n" +
            "6. 搜索结果按时间倒序排序\n" +
            "7. 评论主动显示条数或者展开\n" +
            "8. 修改搜索结果的顶部标题\n" +
            "9. 时间轴支持只选择一个日期\n" +
            ...
            "13. 提供时间顺序浏览的功能\n" +
            "14. 去除登录时密码错误的重复提示\n" +
            "15. 支持修改默认头像、用户名和个性签名\n" +
            "16. 支持修改日记正文的错别字\n" +
            "17. 日记详情支持下拉刷新\n" +
            "18. 设置中允许设置是否自动展开评论区\n" +
            "19. 日记编辑界面给予即将超字数的提示\n" +
            "20. 登录密码错误次数过多将删除所有数据\n" +
            "21. 新增日期显示周几\n" +
            "22. 修复初次使用软件生成的提示日记导致的BUG";
    ...
    public static final String STRING_UPDATE_12 = "2022年5月29日更新1.3.2版本。\n" +
            "1. 数据分析新增字数段统计、雨天的判定改进\n" +
            "2. 纪念日的结束时间可更改\n" +
            "3. 图库/视频库/图片界面/纪念日界面不可截图\n" +
            "4. 提示切换输入法\n" +
            "5. 修改密码的提示/关于中的部分信息更新/新增免责声明";
    ...
    public static final String STRING_UPDATE_19 = "2025年1月1日更新1.5.3版本\n" +
            ...
            "3. 更换UI-更换默认主色调\n" +
            "4. 更换功能逻辑-往年今日的数据按时间顺序展示\n" +
            "5. 更换功能-保存单篇日记为PDF的功能换成保存图片\n" +
            "6. 更换文本-首屏设置的相关文本、帮助关于的文本\n" +
            "7. 其他-更换glide版本；新加入pictureselector依赖;文件删除时，只允许删除自己创建的目录下的文件\n" +
            "8. 新增功能-检查更新按钮（虽然不支持自动更新）\n" +
            "9. 优化功能-可以保存点赞收款码\n";

    public static final String STRING_UPDATE_0 = "2025年1月18日更新此版本（1.5.4）\n" +
