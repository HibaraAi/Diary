...
public class Constant {
    ...
    public static final String STRING_HELP_3 = "\n三、权限使用说明\n" +
            ...
            "但你就只能使用部分功能了。其实想想也知道，日记配图肯定要从手机相册读取，这就用到读权限，" +
    ...
    public static final String STRING_HELP_6 = "\n六、Q&A\n" +
            ...
            "如果是非日记配图的图，应该在Config目录下。软件自带的图全部不能导出。\n" +
            "Q：我要怎么反映BUG？\n" +
    ...
    public static final String STRING_HELP_7 = "\n七、写在最后\n" +
            ...
            "\n八、本次更新内容\n" +
            "明文导出、置顶功能、长按日记文本改为弹出菜单、修正“搜索结果按时间倒序排序”、" +
            "改善“时间轴支持只选择一个日期”、查看已有标签、图片加载失败时显示默认图片、" +
            "提供时间顺序浏览、编辑已有日记的正文、日记详情支持刷新、设置中允许设置是否自动展开评论区、" +
            "写日记时即将超字数时给予提示、新增日期显示周几、改默认头像用户名和个性签名\n";
