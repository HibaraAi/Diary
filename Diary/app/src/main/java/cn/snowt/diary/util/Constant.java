...
//            "A：别问，问就是BUG，目前来看这是偶发BUG，问题不大，不修。多点一下就可以回到顶部。\n" +
            ...
            "点“Issues”，之后你应该看得懂的了)。或者发送邮件到3192233122@qq.com，邮件标题注明“消消乐BUG反馈”。或者B站私信。反馈bug时希望你能带上闪退信息。\n" +
            ...
            "Q6：我好像没有找到“检查更新”的按钮啊？\n" +
            "A：目前整个软件都没有接入网络服务，你可以到我B站视频的评论区看看我更新了欸，也可以在开源代码的网址中检查这个项目有没有发布新的release，" +
    ...
    public static final String STRING_UPDATE_0 = "2024年10月7日更新此版本（1.5.2.1）\n" +
